...
public class Brella_Behav : MonoBehaviour
{
    ...
    [SerializeField]
    private int PelletDmg;

    [SerializeField]
    private int ShieldRegenHP;
    ...
    void Start()
    {
        ...
        tempObject.GetComponent<UI_behavior>().ChangeWeapon("Brella", gameObject);
    ...
    void Update()
    {
        ...
        {
            if (cooldown < 1 && Input.GetMouseButtonDown(0) && InkM.getInk() > InkPerShot)
            {
                animRep = 60;
                ...
                for (int i = 0; i < Pellets; i++)
                {
                    ...
                    obj.GetComponent<Bullet_Behaviour>().dmg = PelletDmg;
